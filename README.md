...
Le coefficient de force et la seule partie renvoi du coefficient d'agilité sont ensuite multipliés selon `TOTAL_TP` : ×0,5 sous 8 ; ×1 dès 16 ; ×1,5 dès 24 ; ×1,7 dès 32. Les `if` sont indépendants et cumulatifs : le facteur effectif vaut ×1 de 8 à moins de 24 PT, ×1,5 de 24 à moins de 32, puis **×2,55 dès 32 PT**. Le `×1` est conservé comme palier facilement réglable. Aucune distance n'entre dans ces coefficients ; elle reste traitée par le placement final.
